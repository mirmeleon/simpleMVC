...
namespace SimpleMVC.App.Views.Menu
{
    public class Details : IRenderable<DetailsViewModel>
    {
        ...
        public string Render()
        {
            ...
            htmlContent.AppendLine("<!doctype html><html lang=\"en\"><head><meta charset=\"UTF-8\" /><title>PizzaMore - Details</title><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" /><link rel=\"stylesheet\" href=\"/../../Content/bootstrap/css/bootstrap.min.css\" /><link rel=\"stylesheet\" href=\"/../../Content/css/signin.css\" /></head><body><div class=\"container\">");
            htmlContent.AppendLine("<div class=\"jumbotron\">");
            htmlContent.AppendLine("<a class=\"btn btn-danger\" href=\"/menu/index\">All Suggestions</a>");
